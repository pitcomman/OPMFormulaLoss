...
Public Class FormulaLossAmount__NEW20220830
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FormulaLossAmount _NEW20220830.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPMFormulaLoss.FormulaLossAmount _NEW20220830.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormulaLossAmount__NEW20220830
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FormulaLossAmount__NEW20220830 = New FormulaLossAmount__NEW20220830()
        rpt.Site = Me.Site
        Return rpt
    End Function
