...
Public Class FormulaLossUnit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPMFormulaLoss.FormulaLossUnit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormulaLossUnit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FormulaLossUnit = New FormulaLossUnit()
        rpt.Site = Me.Site
        Return rpt
    End Function
