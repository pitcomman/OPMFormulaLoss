...
Public Class FormulaLossSumRate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPMFormulaLoss.FormulaLossSumRate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormulaLossSumRate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FormulaLossSumRate = New FormulaLossSumRate()
        rpt.Site = Me.Site
        Return rpt
    End Function
