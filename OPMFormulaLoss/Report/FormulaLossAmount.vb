...
Public Class FormulaLossAmount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPMFormulaLoss.FormulaLossAmount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormulaLossAmount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FormulaLossAmount = New FormulaLossAmount()
        rpt.Site = Me.Site
        Return rpt
    End Function
