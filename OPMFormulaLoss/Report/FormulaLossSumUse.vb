...
Public Class FormulaLossSumUse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPMFormulaLoss.FormulaLossSumUse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormulaLossSumUse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FormulaLossSumUse = New FormulaLossSumUse()
        rpt.Site = Me.Site
        Return rpt
    End Function
