...
Public Class CmnMasterTable
    ...
    Public Function GetPurposeTable(ByVal pstrGroupCode As String, ByVal pstrCode As String) As DataTable
        ...
        Try
            ...
            objSqlCmd.CommandText = "Select * From " & CmnUtil.Purpose_DataBase_Name & ".dbo.Purpose Where GroupCode='" & pstrGroupCode & "' And Code='" & pstrCode & "'"
    ...
    Public Function GetPurposeTable(ByVal pstrGroupCode As String) As DataTable
        ...
        Try
            ' create command object
            objSqlCmd = New SqlCommand
            objSqlCmd.CommandText = "Select * From " & CmnUtil.Purpose_DataBase_Name & ".dbo.Purpose Where GroupCode='" & pstrGroupCode & "' Order by Code"
            objSqlCmd.CommandType = CommandType.Text
