...
Public Class CmnUtil
    ...
    Public Const INIT_XML_PATH As String = ""

    ' Error log path
    Public Const ERR_LOG_NAME As String = "Error.log"
    ...
    Public Const PURPOSE_NAME As String = "purpose"
    Public Shared Purpose_DataBase_Name As String
